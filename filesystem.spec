...
%posttrans -p <lua>
-- Perform the usr/ merge if some packages are installing to
-- non-merged locations. This handles things like symlinks from
-- /bin/<file> to /usr/bin/<file>
...
-- print('Moving bin to usr/bin')
link_moved_dir('bin', 'usr/bin')

-- print('Moving sbin to usr/sbin')
link_moved_dir('sbin', 'usr/sbin')

-- print('Moving lib to usr/lib')
link_moved_dir('lib', 'usr/lib')
